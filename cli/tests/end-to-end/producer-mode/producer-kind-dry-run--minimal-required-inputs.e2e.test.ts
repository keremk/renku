...
import {
	CLI_FIXTURES_PRODUCERS,
	CLI_FIXTURES_INPUTS,
} from '../../test-catalog-paths.js';

const PRODUCER_PATH = resolve(
	CLI_FIXTURES_PRODUCERS,
	'producer-kind-text-to-video',
	'producer-kind-text-to-video.yaml'
);
const MINIMAL_INPUTS_PATH = resolve(
	CLI_FIXTURES_INPUTS,
	'producer-kind-dry-run--minimal.inputs.yaml'
);
