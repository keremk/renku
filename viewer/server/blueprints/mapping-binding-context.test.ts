...
import { loadYamlBlueprintTree, type BlueprintTreeNode } from '@gorenku/core';
import {
...
describe('mapping-binding-context', () => {
  it('extracts producer aliases from canonical graph target node ids', () => {
  ...
  it('classifies mapping sources directly from graph node types', () => {
    const root = createFixtureTree();
  ...
  it('resolves real producer bindings without requiring decomposed source nodes', async () => {
