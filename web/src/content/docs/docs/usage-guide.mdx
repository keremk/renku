...
6. **Use `--aid` for surgical fixes** - If specific segments need work, regenerate just those artifacts instead of the whole layer (e.g., `--aid=Artifact:AudioProducer.GeneratedAudio[0] --aid=Artifact:AudioProducer.GeneratedAudio[2]`)
