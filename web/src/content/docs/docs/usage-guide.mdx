...
Before spending API credits, validate your configuration with preflight and then dry run:
...
Preflight loads the real inputs and model selections, prepares the graph, checks viewer projection, and verifies the planned execution shape before any simulated or live producer runs.
...
For more detail, see [Blueprint Validation and Preflight](/docs/blueprint-validation-and-preflight).
