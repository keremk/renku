...
- **[Install Page](/install)** - Choose macOS app or CLI setup for Linux/Windows (WSL)
- **[Quick Start - Renku App](/docs/app-quick-start)** - Get up and running in minutes with the downloadable app
