...
Renku is a workflow and build system for AI video. It coordinates scripts, prompts, images, audio, video clips, timelines, and exports so you can generate repeatable videos without hand-copying files between many provider dashboards.
...
- **[Blueprint Validation and Preflight](/docs/blueprint-validation-and-preflight)** - Understand validation, preflight, dry-run coverage, and safe graph wiring
