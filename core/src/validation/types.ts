...
export const ValidationErrorCode = {
  ...
  SEGMENT_DURATION_INPUT_DECLARED: 'V014',
  SEGMENT_DURATION_REQUIRES_DURATION_INPUT: 'V015',
  SEGMENT_DURATION_REQUIRES_NUM_SEGMENTS_INPUT: 'V016',
  ...
  // Condition validation errors (V050-V055)
