...
export const ParserErrorCode = {
  ...
  MISSING_PRODUCER_IMPORT_SOURCE: 'P035',
  INVALID_PRODUCER_BLUEPRINT_KIND: 'P036',
  ...
  // P050-P059: Fan-in/connection parsing
  COLLECTORS_SECTION_REMOVED: 'P053',
...
export const ValidationErrorCode = {
  ...
  MEDIA_PRODUCER_MISSING_DURATION_INPUT: 'V012',
  MEDIA_PRODUCER_MISSING_DURATION_BINDING: 'V013',
  ...
  VIEWER_PROJECTION_INVALID: 'V052',
...
export const RuntimeErrorCode = {
  ...
  MISSING_CANONICAL_CONDITION_ARTIFACT: 'R014',
  ...
  PLAN_NOT_FOUND: 'R110',
  CLI_CONFIG_MISSING: 'R111',
  JOB_NOT_FOUND: 'R112',
  JOB_ALREADY_RUNNING: 'R113',
  VIEWER_CONFIG_MISSING: 'R114',
  MODELS_PANE_DESCRIPTOR_MISSING_FOR_MODEL: 'R115',
  MODELS_PANE_PREVIEW_FIELD_OUTSIDE_DESCRIPTOR: 'R116',
  MODELS_PANE_MISSING_BINDING_METADATA_ALIAS: 'R117',
  MODELS_PANE_MISSING_VIEWER_ANNOTATION: 'R118',
  ...
  INVALID_PRODUCER_OVERRIDE_FORMAT: 'R132',
  UNKNOWN_PRODUCER_OVERRIDE_TARGET: 'R133',
  PRODUCER_OVERRIDE_INVALID_COUNT: 'R134',
  DUPLICATE_PRODUCER_OVERRIDE: 'R135',
  PRODUCER_OVERRIDE_DEPENDENCY_MISSING: 'R137',
  PLANNING_CONFLICT_REGEN_PIN: 'R138',

  // R139-R149: Viewer parse loop grouping
  LOOP_GROUP_DERIVATION_ERROR: 'R139',
