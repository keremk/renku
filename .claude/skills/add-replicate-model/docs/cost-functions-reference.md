...
| `costByVideoDurationAndMode` | `[duration, mode]` | `prices[].mode + pricePerSecond` | Duration varies by mode (standard/pro) |
| `costByVideoDurationModeAndAudio` | `[duration, mode, generate_audio]` | `prices[].mode + generate_audio + pricePerSecond` | Duration + mode + audio toggle |
