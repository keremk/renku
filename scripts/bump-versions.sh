...
echo "  - @renku/core@$(node -p "require('./core/package.json').version")"
echo "  - @renku/compositions@$(node -p "require('./compositions/package.json').version")"
echo "  - @renku/providers@$(node -p "require('./providers/package.json').version")"
echo "  - @renku/cli@$CLI_VERSION"
echo ""
